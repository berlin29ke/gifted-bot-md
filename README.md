...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://qr-scan.giftectechnexus.co.ke/) Or [`PARING CODE`](https://replit.com/@mauricegift045/GiftedTechPairingCode#index.js). And then `Go-to Whatapp>Three dots>Linked Devices`***
